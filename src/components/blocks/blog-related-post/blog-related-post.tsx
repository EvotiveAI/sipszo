    ...
    <section className='py-8 sm:py-16 lg:py-24'>
      <div className='mx-auto max-w-7xl space-y-16 px-4 py-8 sm:px-6 lg:px-8'>
        ...
        <div className='space-y-4'>
          <Badge variant='outline' className='text-xs uppercase tracking-[0.15em]'>Kapcsolódó cikkek</Badge>

          <h2 className='text-2xl font-bold tracking-tight md:text-3xl lg:text-4xl'>Ezeket is érdemes elolvasni</h2>

          <p className='text-muted-foreground text-lg md:text-xl'>
            Szerkesztőségünk által válogatott, tematikusan kapcsolódó írások.
          </p>
        </div>
